...
/**
 * Long-running workflow that accumulates price updates and sends them in batches.
 * This is a singleton workflow (single instance handles all price updates globally).
 * 
 * Batching Strategy:
...
public interface SendPriceUpdateToChannelWorkflow {
    ...
    /**
     * Signal method to add a price update to the batch.
     * @param item Price update to add to batch
     */
    @SignalMethod
    void addPriceUpdate(PriceBatchItem item);
